        ...
        <Card className="border-0 rounded-lg shadow-md overflow-hidden lg:col-span-2">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600">
              We deployed a full-scale Odoo ERP system tailored for an East
              African textile manufacturer. The solution covered production,
              inventory, sales, and logistics, enabling streamlined operations,
              improved efficiency, and real-time visibility across departments.
            </p>
          </div>
        </Card>
