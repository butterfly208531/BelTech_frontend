...
const Contact = () => {
  ...
  return (
    <div className="font-sans antialiased bg-[rgba(175,218,223,0.1)] text-gray-900">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Input
                    ...
                    className={`py-3 px-4 border rounded-lg focus:ring-2 focus:ring-[#61C7D5] focus:border-[#61C7D5] ${errors.firstName ? "border-red-500" : "border-gray-300"}`}
                  />
                  ...
                  <Input
                    ...
                    className={`py-3 px-4 border rounded-lg focus:ring-2 focus:ring-[#61C7D5] focus:border-[#61C7D5] ${errors.lastName ? "border-red-500" : "border-gray-300"}`}
                  />
                ...
                <Input
                  ...
                  type="email"
                  placeholder="Email*"
                  className={`w-full py-3 px-4 border rounded-lg focus:ring-2 focus:ring-[#61C7D5] focus:border-[#61C7D5] ${errors.email ? "border-red-500" : "border-gray-300"}`}
                />
                ...
                <Input
                  ...
                  className={`w-full py-3 px-4 border rounded-lg focus:ring-2 focus:ring-[#61C7D5] focus:border-[#61C7D5] ${errors.phone ? "border-red-500" : "border-gray-300"}`}
                />
                ...
                <Input
                  ...
                  className={`w-full py-3 px-4 border rounded-lg focus:ring-2 focus:ring-[#61C7D5] focus:border-[#61C7D5] ${errors.organization ? "border-red-500" : "border-gray-300"}`}
                />
                ...
                <Textarea
                  ...
                  className={`w-full py-3 px-4 border rounded-lg focus:ring-2 focus:ring-[#61C7D5] focus:border-[#61C7D5] min-h-[150px] ${errors.message ? "border-red-500" : "border-gray-300"}`}
                />
