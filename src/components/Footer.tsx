        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Home", "Services", "About Us", "Solutions in Action", "Insights", "Contact"].map((link) => (
                <li key={link}>
                  <a href="#" className="text-gray-300 hover:text-[#61C7D5] transition-colors duration-200">{link}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              ...
              />
              <Button className="flex-1 px-3 py-2 rounded-r-md rounded-l-none bg-[#61C7D5] hover:bg-[#4aa1c8] text-white transition-colors duration-200">
                Subscribe
              </Button>
            </div>
          </div>
